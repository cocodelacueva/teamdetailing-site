...
$colors_arr = array(__("Leave it to theme", "js_composer") => "ozy_auto", __("Grey", "js_composer") => "wpb_button", __("Blue", "js_composer") => "btn-primary", __("Turquoise", "js_composer") => "btn-info", __("Green", "js_composer") => "btn-success", __("Orange", "js_composer") => "btn-warning", __("Red", "js_composer") => "btn-danger", __("Black", "js_composer") => "btn-inverse");
...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
      ...
      "value" => array(__("ozythemes Portfolio Layout", "js_composer") => "portfolio", __("ozythemes Portfolio Layout (Classic)", "js_composer") => "portfolio-classic",__("Title + Thumbnail + Text", "js_composer") => "title_thumbnail_text", __("Thumbnail + Title + Text", "js_composer") => "thumbnail_title_text", __("Thumbnail + Text", "js_composer") => "thumbnail_text", __("Thumbnail + Title", "js_composer") => "thumbnail_title", __("Thumbnail only", "js_composer") => "thumbnail", __("Title + Text", "js_composer") => "title_text", __("Text + Title (Testimonial Slider)", "js_composer") => "text_title"),
      "description" => __("Grid layout.", "js_composer")
    ),
    array(
      "type" => "dropdown",
